...
const Constants = {
  ...
  APP_CHRISTMAS_RECIPES_POSTS: APP_DOMAIN +'/rest/recetas/all',
  APP_CHRISTMAS_RECIPES_DETAILS: APP_DOMAIN +'/rest/receta/',
  APP_MENU_MAIN: APP_DOMAIN +'/menu-principal',
  APP_DOMAIN_USER_LOGIN : '/user/login?_format=json',
  APP_DOMAIN_USER_REGISTER : '/user/register?_format=json',
  APP_DOMAIN_USER_INFO : '/jsonapi/user/user'
}
